...
import com.rongsheng.voiceimagerecognition.adapter.MyPagerAdapter;
import com.rongsheng.voiceimagerecognition.utils.BitmapUtils;
import com.rongsheng.voiceimagerecognition.view.cropview.CropView;

import java.io.File;
import java.util.ArrayList;
import java.util.List;

import static com.rongsheng.voiceimagerecognition.utils.SDUtils.assets2SD;

/**
 * Created by hang on 2018/3/26 0026.
 */
...
public class ImageActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private int[] ids = new int[]{R.mipmap.chaxun, R.mipmap.fan, R.mipmap.fengying,
            R.mipmap.meishi, R.mipmap.mj, R.mipmap.mjn, R.mipmap.quanbu, R.mipmap.tupian, R.mipmap.yingyu, R.mipmap.zheng,
            R.mipmap.xingming, R.mipmap.minzu, R.mipmap.zengzhi, R.mipmap.wode};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cropView.setOnTouchListener((v, event) -> {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == RESULT_OK) {
            if (requestCode == PICK_REQUEST_CODE) {
                ...
                resultIv.setVisibility(View.INVISIBLE);
                cropView.of(source).withAspect(cropWidth, cropHeight).initialize(ImageActivity.this);
            }
        }
    }
